...
--
-- Name: bohrprofil_bohrprofil_id_seq; Type: SEQUENCE SET; Schema: bohrung
--

SELECT pg_catalog.setval('bohrung.bohrprofil_bohrprofil_id_seq', 4183, true);


--
-- Name: bohrung_bohrung_id_seq; Type: SEQUENCE SET; Schema: bohrung
--

SELECT pg_catalog.setval('bohrung.bohrung_bohrung_id_seq', 3432, true);


--
-- Name: code_code_id_seq; Type: SEQUENCE SET; Schema: bohrung
--

SELECT pg_catalog.setval('bohrung.code_code_id_seq', 179, true);


--
-- Name: codeschicht_codeschicht_id_seq; Type: SEQUENCE SET; Schema: bohrung
--

SELECT pg_catalog.setval('bohrung.codeschicht_codeschicht_id_seq', 31, true);


--
-- Name: codetyp_codetyp_id_seq; Type: SEQUENCE SET; Schema: bohrung
--

SELECT pg_catalog.setval('bohrung.codetyp_codetyp_id_seq', 12, true);


--
-- Name: schicht_schicht_id_seq; Type: SEQUENCE SET; Schema: bohrung
--

SELECT pg_catalog.setval('bohrung.schicht_schicht_id_seq', 9527, true);


--
-- Name: standort_standort_id_seq; Type: SEQUENCE SET; Schema: bohrung
--

SELECT pg_catalog.setval('bohrung.standort_standort_id_seq', 2379, true);


--
-- Name: vegasBohrungen_gid_seq; Type: SEQUENCE SET; Schema: bohrung
--

SELECT pg_catalog.setval('bohrung."vegasBohrungen_gid_seq"', 2807, true);


--
-- Name: vorkommnis_vorkommnis_id_seq; Type: SEQUENCE SET; Schema: bohrung
--

SELECT pg_catalog.setval('bohrung.vorkommnis_vorkommnis_id_seq', 6717, true);
